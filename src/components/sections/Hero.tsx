      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
        ...
        >
          <span className="inline-block px-4 py-1.5 rounded-full bg-gold/10 border border-gold/30 text-gold text-sm font-medium mb-6">
            🎵 Premier Bollywood DJ in the UK
          </span>
        </motion.div>
        ...
        >
          Your Bollywood Celebration{" "}
          <span className="text-gold">Deserves the Perfect DJ</span>
        </motion.h1>
        ...
        >
          From romantic wedding moments to electrifying sangeet nights — I bring
